...
const categories = ["Doa Harian", "Doa Ramadan"] as const;
        ...
        >
            ...
            <div className="bg-white px-5 pt-12 pb-6 border-b border-[#E8ECE9]/30 shadow-[0_4px_30px_rgba(0,0,0,0.02)]">
                ...
                <div className="flex gap-2">
                    <div className="flex-1 h-11 bg-[#F4F4F6] rounded-xl flex items-center px-4 gap-3 border border-[#E8ECE9]/50 shadow-inner overflow-hidden">
